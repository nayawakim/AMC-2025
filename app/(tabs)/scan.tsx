...
export default function ScanScreen() {
  ...
  const handleBarcodeScanned = async (result: any) => {
    ...
    try {
      ...
      if (!qrData.id || typeof qrData.infected !== 'boolean') {
        setScanError('Format QR invalide! Attendu: { "id": string, "infected": boolean }');
        return;
      }
      ...
      if (qrData.infected) {
        try {
          ...
          console.log(`Utilisateur ${qrData.id} marqué comme infecté`);
        } catch (err) {
      ...
      setScanError("QR code invalide! Le contenu doit être un JSON valide.");
    }
  };
  ...
  const scanAreaBorderColor = scannedUser
    ? (scannedUser.infected ? "#ef4444" : "#22c55e")
    : "#ef4444";
        ...
        <View style={styles.overlay}>
          ...
          <Text style={styles.scanText}>
            {isScanning
              ...
              : scannedUser
                ? (scannedUser.infected ? "⚠️ PERSONNE INFECTÉE" : "✓ Personne saine")
                : "Erreur de scan"
            }
          </Text>
        </View>
            ...
            {scannedUser.infected ? (
              ...
              <View style={styles.infectedCard}>
                <View style={styles.infectedHeader}>
                  ...
                  <Text style={styles.infectedTitle}>INFECTÉ</Text>
                </View>
                <Text style={styles.infectedDescription}>
                  Éloignez-vous immédiatement de cette personne !
                </Text>
                <View style={styles.userIdContainer}>
                  <Text style={styles.userIdLabel}>ID Utilisateur:</Text>
              ...
              <View style={styles.safeCard}>
                ...
                <Text style={styles.safeDescription}>
                  Cette personne n'est pas infectée. Vous pouvez interagir en toute sécurité.
                </Text>
                <View style={styles.userIdContainer}>
                  <Text style={styles.userIdLabel}>ID Utilisateur:</Text>
                  <Text style={styles.userIdText}>{scannedUser.id}</Text>
