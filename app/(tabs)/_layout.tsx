    ...
    <Tabs
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ focused }) => {
          ...
          if (route.name === "map") {
            source = focused ? icons.map.active : icons.map.inactive;
          } else if (route.name === "chat") {
            source = focused ? icons.chat.active : icons.chat.inactive;
          } else if (route.name === "scan") {
            source = focused ? icons.scan.active : icons.scan.inactive;
          } else {
            return null;
          }
          if (route.name === "map") {
